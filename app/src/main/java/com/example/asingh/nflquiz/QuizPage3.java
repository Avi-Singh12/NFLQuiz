 ...
 */
public class QuizPage3 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answerButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(QuizPage3.this, "Incorrect", Toast.LENGTH_SHORT).show();
        ...
        answerButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(QuizPage3.this, "Correct", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(getApplicationContext(), QuizPage4.class);
                i.putExtra("USER_NAME", username);
